...
struct Z_Construct_UClass_UMyBaseAnimInstance_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SwayRotation_MetaData[] = {
		{ "Category", "Animation|Player" },
		{ "ModuleRelativePath", "Public/Animation/MyBaseAnimInstance.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_SwayRotation;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMyBaseAnimInstance_Statics::NewProp_SwayRotation = { "SwayRotation", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMyBaseAnimInstance, SwayRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SwayRotation_MetaData), NewProp_SwayRotation_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMyBaseAnimInstance_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMyBaseAnimInstance_Statics::NewProp_SwayRotation,
};
...
struct Z_CompiledInDeferFile_FID_unreal_project_FPS_COOP_Game_FPSGame_Source_FPSGame_Public_Animation_MyBaseAnimInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMyBaseAnimInstance, UMyBaseAnimInstance::StaticClass, TEXT("UMyBaseAnimInstance"), &Z_Registration_Info_UClass_UMyBaseAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyBaseAnimInstance), 300040611U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_project_FPS_COOP_Game_FPSGame_Source_FPSGame_Public_Animation_MyBaseAnimInstance_h_523362424(TEXT("/Script/FPSGame"),
