...
public:
	...
	void PlayMontageOnCharacter( UAnimMontage* Montage , const bool bAllowWhileFalling = false, const bool bAllowMontageOverlap = false, const bool bCanStopCurrentMontage = false);
